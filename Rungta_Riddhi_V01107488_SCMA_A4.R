...
survey_df<-read.csv("C:\\Users\\RIDDHI\\OneDrive\\Desktop\\Bootcamp\\SCMA\\SCMA A4\\Survey.csv",header=TRUE) 
dim(survey_df) 
names(survey_df) 
head(survey_df) 
str(survey_df)
...
icecream_df<-read.csv('C:\\Users\\RIDDHI\\OneDrive\\Desktop\\Bootcamp\\SCMA\\SCMA A4\\Icecream.csv',header=TRUE)
dim(icecream_df)
...
#conjoint analysis
# Load data
df <- read.csv('C:\\Users\\RIDDHI\\OneDrive\\Desktop\\Bootcamp\\SCMA\\SCMA A4\\pizza_data.csv')
